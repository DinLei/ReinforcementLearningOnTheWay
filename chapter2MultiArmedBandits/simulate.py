...
def figure_2_4(runs=2000, time=1000):
    bandits = list()
    bandits.append(KArmedBandits(epsilon=0, confidence=2))
...
def figure_2_6(runs=2000, time=1000):
    ...
    generators = [lambda epsilon: KArmedBandits(epsilon=epsilon),
                  ...
                  lambda conf: KArmedBandits(epsilon=0, confidence=conf),
                  lambda initial: KArmedBandits(epsilon=0, initial_value=initial, alpha=0.1)]
